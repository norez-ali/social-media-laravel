                                    ...
                                    @foreach ($user->stories as $story)
                                        <div class="item">
                                            <div data-bs-toggle="modal" data-bs-target="#Modalstory"
                                                ...
                                                style="background-image: url('{{ asset('storage/' . $story->media) }}'); background-size: cover; background-position: center;">
                                                <div
                                                    ...
                                                    <a href="#">
                                                        <figure
                                                            ...
                                                            <div class=" rounded-circle overflow-hidden bg-white shadow-xss"
                                                                ...
                                                                <img src="{{ $user->profile && $user->profile->profile_photo
                                                                    ...
                                                                    alt="image"
                                                                    class="w-12 h-14 rounded-circle object-cover object-top" />
                                                            </div>
                                                        </figure>
        ...
        <script>
            ...
            $("#mediaInput").on("change", function(e) {
                ...
                if (file.type.startsWith("image/")) {
                    preview.append(`<img src="${url}" class="w-full h-full object-cover rounded-lg" />`);
