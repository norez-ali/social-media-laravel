<div class="row">
    <div class="col-xl-4 col-xxl-3 col-lg-4 pe-0 ">
        ...
        <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3">
            ...
            <div class="card-body d-block p-4">
                ...
                <div id="bioDisplay">
                    @if ($user->profile->bio)
                        <p class="profile-bio fw-500 text-grey-500 lh-24 font-xssss mb-2 border rounded-lg p-2">
                            {{ $user->profile->bio }}
                        </p>
                    @else
                    ...
                    @if ($user->id == auth_user()->id)
                        <button onclick="toggleBioEdit(true)" class="w-full bg-gray-300 rounded-lg hover:bg-gray-400">
                            Edit Bio
                        </button>
                    @endif
                </div>
                ...
                <div id="detailsEdit" class="hidden">
                    <form action="{{ route('user.updateProfile') }}" method="POST" class="ajax-form">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" name="education" value="{{ $user->profile->education }}"
        ...
        <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3">
            <div class="card-body d-flex align-items-center  p-4">
                ...
                <a href="{{ route('user.profile.photos', $user->id) }}"
    ...
    <div class="col-xl-8 col-xxl-9 col-lg-8">
        ...
        @foreach ($user->posts as $post)
            <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3 mt-3" id="post-{{ $post->id }}">
                ...
                @if (is_array($post->media) && count($post->media))
                    <div class="card-body d-block p-0">
                        @if (count($post->media) === 1)
                            ...
                            @if ($file['media_type'] === 'image')
                                <a href="{{ $file['file_path'] }}" data-lightbox="post-{{ $post->id }}">
                                    <img src="{{ $file['file_path'] }}"
                                        class="rounded-3 w-100 h-auto object-cover shadow-sm" alt="Post image">
                                </a>
                    ...
                    <div id="commentsPopup"
                        ...
                        <div class="bg-white rounded-3 shadow p-3 w-100"
                            ...
                            <div class="d-flex justify-content-between align-items-center border-bottom pb-2 mb-2">
                                ...
                                <button onclick="toggleComments(false)" class="btn btn-sm btn-light">✕</button>
                            </div>
                            ...
                            <form id="commentForm" action="{{ route('user.add.comment', $post->id) }}"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!-- Input -->
                                    <input type="text" id="newComment" name="content" class="form-control me-2"
