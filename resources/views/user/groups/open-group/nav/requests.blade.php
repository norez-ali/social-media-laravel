<div class="col-12">
    ...
    <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3 bg-white">
        <h2 class="font-bold mb-3">Pending Requests</h2>
                    ...
                    <div class="card border-0 shadow-xss rounded-3 overflow-hidden h-100">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="fw-500 font-xsssss text-grey-500 mt-0 mb-3">
                                {{ $user->profile->name ?? 'username' }}</p>

                            <!-- Buttons -->
                            <div class="d-flex justify-content-between">
                                <a href="javascript:void(0);" data-group-id="{{ $group->id }}"
                                    data-user-id="{{ $user->id }}"
                                    class="approve-request text-center p-2 flex-fill me-1 d-inline-block rounded-xl bg-primary font-xsssss fw-700 text-white">
                                    Approve
                                </a>
                                <a href="javascript:void(0);" data-group-id="{{ $group->id }}"
                                    data-user-id="{{ $user->id }}"
                                    class="reject-request text-center p-2 flex-fill ms-1 d-inline-block rounded-xl bg-light text-dark font-xsssss fw-700">
                                    Reject
                                </a>
                            </div>
                        </div>
